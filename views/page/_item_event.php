...
<div class="ep-repeat-item" data-ep-repeat-item>
    <div class="form-group">
        <label class="ep-label"><?= Yii::t('ThiscoveryPageBuilderModule.base', 'Event title') ?></label>
        <input type="text" class="form-control" name="<?= $namePrefix ?>[title]"
               value="<?= Html::encode($item['title'] ?? '') ?>">
    </div>
    <div class="row g-2">
        <div class="col-md-4 form-group">
            <label class="ep-label"><?= Yii::t('ThiscoveryPageBuilderModule.base', 'Date') ?></label>
            <input type="text" class="form-control" name="<?= $namePrefix ?>[date]"
                   placeholder="YYYY-MM-DD" value="<?= Html::encode($item['date'] ?? '') ?>">
        </div>
        <div class="col-md-4 form-group">
            <label class="ep-label"><?= Yii::t('ThiscoveryPageBuilderModule.base', 'Time') ?></label>
            <input type="text" class="form-control" name="<?= $namePrefix ?>[time]"
                   value="<?= Html::encode($item['time'] ?? '') ?>">
        </div>
        <div class="col-md-4 form-group">
            <label class="ep-label"><?= Yii::t('ThiscoveryPageBuilderModule.base', 'Location') ?></label>
    ...
    <div class="row g-2">
        <div class="col-md-8 form-group">
            <label class="ep-label"><?= Yii::t('ThiscoveryPageBuilderModule.base', 'Registration URL') ?></label>
        ...
        <div class="col-md-4 form-group">
            ...
            <input type="text" class="form-control" name="<?= $namePrefix ?>[cta_label]"
                   value="<?= Html::encode($item['cta_label'] ?? Yii::t('ThiscoveryPageBuilderModule.base', 'Register')) ?>">
        </div>
    </div>
