...
$this->title = Yii::t('EngagementPagesModule.base', 'Engagements');
?>
<div class="ep-directory">
    <header class="ep-directory__hero">
        <h1><?= Yii::t('EngagementPagesModule.base', 'Shape local health services') ?></h1>
        <p><?= Yii::t('EngagementPagesModule.base', 'Browse open consultations and surveys. Tell us what matters to you.') ?></p>
    </header>

    <?php if ($pages === []): ?>
        <p class="text-muted"><?= Yii::t('EngagementPagesModule.base', 'No open engagements are listed yet.') ?></p>
    <?php else: ?>
        <?php
        ...
        <?php if ($featured !== []): ?>
            <h2 class="ep-directory__heading"><?= Yii::t('EngagementPagesModule.base', 'Open for feedback') ?></h2>
        ...
        <?php if ($rest !== []): ?>
            <h2 class="ep-directory__heading"><?= Yii::t('EngagementPagesModule.base', $featured ? 'More engagements' : 'Open for feedback') ?></h2>
            <div class="ep-directory__grid">
